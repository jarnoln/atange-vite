...
describe('Test QuestionStore', () => {
  ...
  it('moves question up', () => {
    questionStore.addQuestion('q1', 'Q1')
    questionStore.addQuestion('q2', 'Q2')
    questionStore.addQuestion('q3', 'Q3')
    expect(questionStore.questions[0].order).toBe(0)
    expect(questionStore.questions[1].order).toBe(1)
    expect(questionStore.questions[2].order).toBe(2)
    ...
    expect(questionStore.moveQuestionUp('q3')).toBe(true)
    expect(questionStore.questions[0].order).toBe(0)
    expect(questionStore.questions[1].order).toBe(1)
    expect(questionStore.questions[2].order).toBe(2)
    expect(questionStore.questions[0].name).toBe('q1')
    ...
    expect(questionStore.questions[2].name).toBe('q2')
    expect(questionStore.moveQuestionUp('q3')).toBe(false)
    expect(questionStore.questions[0].name).toBe('q3')
    expect(questionStore.questions[1].name).toBe('q1')
    expect(questionStore.questions[2].name).toBe('q2')
  }),
  it('moves question down', () => {
    ...
    expect(questionStore.questions[1].name).toBe('q2')
    expect(questionStore.questions[2].name).toBe('q3')
    expect(questionStore.moveQuestionDown('q1')).toBe(true)
    expect(questionStore.questions[0].order).toBe(0)
    expect(questionStore.questions[1].order).toBe(1)
    expect(questionStore.questions[2].order).toBe(2)
    expect(questionStore.questions[0].name).toBe('q2')
    expect(questionStore.questions[1].name).toBe('q1')
    expect(questionStore.questions[2].name).toBe('q3')
    expect(questionStore.moveQuestionDown('q1')).toBe(true)
    expect(questionStore.questions[0].name).toBe('q2')
    expect(questionStore.questions[1].name).toBe('q3')
    expect(questionStore.questions[2].name).toBe('q1')
    expect(questionStore.moveQuestionDown('q1')).toBe(false)
    expect(questionStore.questions[0].name).toBe('q2')
    expect(questionStore.questions[1].name).toBe('q3')
    expect(questionStore.questions[2].name).toBe('q1')
  }),
